...
// into the URLs). If you want the signups to credit IndiaConnect's own
...
export const affiliateLinks: AffiliateLink[] = [
  ...
  // ---- Money Transfer --------------------------------------------------
  {
    ...
    description: "Send money between India and Germany at the real exchange rate with low, transparent fees.",
