  ...
  return [
    ...clubs
      ...
      .map((c) => ({
        ...
        name: c.name,
        citySlug: c.citySlug,
        typeLabel: ["regional-associations", "temples-gurudwaras", "dance-music-groups", "student-associations", "professional-networks"].includes(c.categorySlug) ? "Group" : "Sports Club",
      })),
    ...restaurants
