...
export const metadata: Metadata = {
  title: "Impressum",
  description: "Legal notice / Impressum for IndiaConnect Germany.",
};
...
const rows: { label: string; value: React.ReactNode }[] = [
  ...
  },
  {
    label: "Email",
    value: (
      <a href="mailto:indiaconnect@thegermanguy.org" className="text-primary underline underline-offset-4 hover:text-primary/80">
        indiaconnect@thegermanguy.org
      </a>
    ),
  },
