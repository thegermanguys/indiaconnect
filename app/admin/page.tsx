          ...
          <details className="rounded-2xl border border-border bg-surface shadow-soft">
            ...
            <div className="border-t border-border p-6">
              <form action={createClubAction} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <ImageUploadField label="Logo" name="logo" folder="indiaconnect/clubs/logos" />
                <ImageUploadField label="Cover image" name="coverImage" folder="indiaconnect/clubs/covers" />
          ...
          <details className="rounded-2xl border border-border bg-surface shadow-soft">
            ...
            <div className="border-t border-border p-6">
              <form action={createRestaurantAction} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <Field label="Phone" name="phone" />
                <Field label="Maps URL" name="mapsUrl" />
                <ImageUploadField label="Logo" name="logo" folder="indiaconnect/restaurants/logos" />
                <ImageUploadField
                  label="Photos"
                  name="photos"
                  folder="indiaconnect/restaurants/photos"
                  multiple
                  className="sm:col-span-2"
                />
                <Field label="Cuisine tags (comma-separated)" name="cuisine" placeholder="Indian, Tibetan" />
          ...
          <details className="rounded-2xl border border-border bg-surface shadow-soft">
            ...
            <div className="border-t border-border p-6">
              <form action={createEventAction} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                />
                <Field label="Festival tag (optional)" name="festivalTag" placeholder="Diwali, Holi, Navratri, Ganesh Chaturthi…" />
                <Field label="Organizer" name="organizer" />
                <ImageUploadField label="Poster" name="poster" folder="indiaconnect/events/posters" />
