...
export const metadata: Metadata = {
  ...
  description: "Add your sports club, restaurant, cultural or music group, or event listing to IndiaConnect Germany.",
};
  ...
  if (submitted === "1") {
    return (
      <div className="container flex flex-col items-center py-24 text-center">
        <span className="flex h-16 w-16 items-center justify-center rounded-full bg-india-green/10 text-india-green">
