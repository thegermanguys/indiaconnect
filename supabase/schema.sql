-- =============================================================================
-- IndiaConnect Germany — Supabase / PostgreSQL schema
--
...
create table events (
  ...
  festival_tag text,                      -- Diwali | Holi | Navratri | Ganesh Chaturthi | Independence Day | Republic Day | Onam | Pongal | Cricket | Football | Music | Volleyball | Offer | Other
