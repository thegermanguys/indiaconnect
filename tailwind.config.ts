  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        glow: "0 0 0 1px hsl(var(--marigold) / 0.25), 0 12px 40px -8px hsl(var(--saffron) / 0.35)",
      },
      backgroundImage: {
        "hero-gradient":
          "radial-gradient(120% 120% at 15% 0%, hsl(var(--navy) / 0.95) 0%, hsl(var(--navy)) 38%, hsl(222 50% 9%) 78%)",
        "flag-strip":
          "repeating-linear-gradient(90deg, #FF9933 0 30%, #FFFFFF 30% 36%, #1C3FAA 36% 40%, #FFFFFF 40% 46%, #138808 46% 76%, transparent 76% 100%)",
      },
      keyframes: {
        "fade-up": {
