    ...
    <footer className="mt-24 border-t border-border">
        ...
        <div>
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-display text-xl font-semibold text-navy">
              India<span className="text-saffron-deep">Connect</span>
            </span>
          </Link>
          <p className="mt-4 max-w-xs text-sm text-muted-foreground">
            The home of Indians in Germany — regional associations, temples and gurudwaras, restaurants, and events, all in one place.
          </p>
      ...
      <div className="border-t border-border py-6">
        <div className="container flex flex-col items-center justify-between gap-3 text-xs text-muted-foreground sm:flex-row">
          <p>
            © {new Date().getFullYear()} IndiaConnect Germany. Made for the Indian community in Germany.
          </p>
