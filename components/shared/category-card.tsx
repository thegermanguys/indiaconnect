...
const groupAccent: Record<Category["group"], string> = {
  sports: "bg-primary/10 text-saffron-deep group-hover:bg-primary group-hover:text-primary-foreground",
  ...
  life: "bg-flag-chakra/10 text-flag-chakra group-hover:bg-flag-chakra group-hover:text-white",
};
