...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-hero-gradient pb-20 pt-20 sm:pb-28 sm:pt-28">
      {/* ambient saffron/chakra glow, decorative only */}
      <div aria-hidden className="pointer-events-none absolute inset-0 opacity-[0.10]">
        <div className="absolute -left-10 top-10 h-64 w-64 rounded-full bg-flag-saffron blur-3xl" />
        <div className="absolute right-0 top-40 h-72 w-72 rounded-full bg-flag-chakra blur-3xl" />
