  ...
  return {
    ...
    restaurant: {
      ...
      fields: [
        ...
        { name: "cuisine", label: "Cuisine", type: "text", placeholder: "Indian, Tibetan…" },
        { name: "instagram", label: "Instagram URL", type: "text" },
        { name: "facebook", label: "Facebook URL", type: "text" },
        { name: "website", label: "Website URL", type: "text" },
        { name: "description", label: "Description", type: "textarea", required: true },
    ...
    event: {
      ...
      fields: [
        ...
        { name: "festivalTag", label: "Festival tag (optional)", type: "text", placeholder: "Diwali, Holi, Navratri, Ganesh Chaturthi…" },
          ...
          {config.fields.map((field) =>
            field.type === "image" ? (
              <ImageUploadField
                ...
                label={field.label}
                name={field.name}
                folder="indiaconnect/submissions/pending"
